...
const Cart = () => {
  const { cartItems, removeFromCart, updateQuantity, updateAddOnQuantity, cartCount } = useCart();
  ...
  const subtotal = cartItems.reduce((total, item) => {
    const packagePrice = item.selectedPackage ? item.selectedPackage.price : 0;
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-4">
                ...
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3 mb-3">
                     ...
                     />
                    <div>
                      <h3 className="font-semibold text-gray-900">Berco's Test</h3>
                      <p className="text-sm text-gray-600">Shop Name, Block O1, Block O, Sector 12, Noida, Uttar Pradesh 201301</p>
                    </div>
                  </div>
                </div>
