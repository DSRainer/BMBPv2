...
const CustomizationModal = ({ isOpen, onClose }: CustomizationModalProps) => {
  ...
  return (
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        <div className="flex-shrink-0 pt-4 border-t">
          <div className="flex gap-4 justify-end">
            ...
            <Button className="bg-red-600 hover:bg-red-700" onClick={handleGoToCart}>
              Go To Cart
            </Button>
          </div>
        </div>
    ...
    {/* Activity Detail Overlay - Rendered via Portal */}
    {selectedActivity && createPortal(
      ...
      >
        <div 
          className="bg-white rounded-lg max-w-2xl w-[95vw] max-h-[90vh] overflow-y-auto m-4"
          onClick={(e) => e.stopPropagation()}
        >
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold">Additional Add-Ons</h2>
              <button
                onClick={handleCloseOverlay}
