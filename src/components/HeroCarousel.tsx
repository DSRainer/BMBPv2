          ...
          >
            ...
            <div className="container mx-auto px-4 h-full flex flex-col md:flex-row items-center justify-center md:justify-between text-center md:text-left lg:mt-3">
              ...
              <div className="z-10 flex flex-col items-center md:items-start max-w-md">
                <h1 className={`text-4xl md:text-5xl lg:text-6xl  font-bold ${slide.textColor}`}>
                  {slide.title}
                </h1>
                <p className={`mt-4 text-lg ${slide.textColor} opacity-80 italic`}>
                  {slide.subtitle}
                </p>
                <Button
                  size="lg"
                  className={`mt-8 ${slide.buttonColor} text-white hover:opacity-90 font-semibold px-8 py-4 rounded-full shadow-lg text-lg`}
                >
                  {slide.buttonText}
                </Button>
              </div>
